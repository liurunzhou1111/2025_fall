...
exp_dir = '/mnt/home/yf2578/runzhouliu/DriveDreamer2/results'  # PATH TO YOUR EXPERIMENT FOLDER
project_dir = os.path.join(exp_dir, proj_name)
train_data = '/mnt/home/yf2578/runzhouliu/DriveDreamer2/nuScenes-processed/v1.0-mini/cam_all_train/v0.0.2'
test_data = '/mnt/home/yf2578/runzhouliu/DriveDreamer2/nuScenes-processed/v1.0-mini/cam_all_val/v0.0.2'
embed_map_path = '/mnt/home/yf2578/runzhouliu/DriveDreamer2/checkpoints/clip_text_transform_after_pool_panoramic.pkl'

weight_path = '/mnt/home/yf2578/runzhouliu/DriveDreamer2/checkpoints/pretrained_models/drivedreamer2_img_cond/pytorch_gligen_weights.bin' # PATH TO YOUR MODEL  set None to load the latest checkpoint in your project_dir
save_path = '/mnt/home/yf2578/runzhouliu/DriveDreamer2/results/output/v1.0-trainval/drivedreamer2_img_cond' # PATH FOR SAVING GENERATED VIDEO
